...
class BSC201:
    ...
    def move(self,pos_mm):
        ...
        self.channel.MoveAbsolute(30000)
    ...
    def move_relative(self,distance=0.001):
        ...
        self.channel.MoveRelative(30000)
    ...
    def set_velocity_params(self,max_velocity=1,accel= 1):
        ...
        print('Previous settings: max velocity was %0.2f mm/s, acceleration was %0.2f mm/s^2'%(_vel0,_accel0))
        print('New settings: max velocity is %0.2f mm/s, acceleration is %0.2f mm/s^2'%(_vel,_accel))